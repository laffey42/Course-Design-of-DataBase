...
<div id="applyDiv" style="height: 350px">
    <form action="/DB/servlet/student/updateSingleServlet" method="post" id="form">
        <h1>-修改报名信息-</h1>
        <div>${stu_msg}</div>
        <p>学号：<input id="stuId" name="stuId" type="text" value="${student.stuId}"></p>
        <p>姓名：<input id="stuName" name="stuName" type="text" value="${student.stuName}"></p>
        <p>语言：
